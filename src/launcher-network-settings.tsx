...
export function LauncherNetworkSettings({ busy, extensionId, save, snapshot }: NetworkSettingsProps): ReactNode {
  ...
  return <section className="space-y-3" data-testid="tockteam-network-settings">
    ...
    <div hidden={isHidden('CurrencyConversion')}>
    ...
    <div hidden={isHidden('CustomWebSearch')}>
    ...
    <div hidden={isHidden('DeeplTranslator')}>
