...
export function trustedRaycastAssetUrl(imageKey: string | undefined): string | undefined {
  return imageKey === TRUSTED_RAYCAST_TRANSLATE_IMAGE_KEY ? './trusted-raycast/google-translate.png'
    : imageKey === TRUSTED_RAYCAST_KAOMOJI_IMAGE_KEY ? './trusted-raycast-kaomoji/kaomoji-search.png' : undefined
}
...
export function trustedRaycastCatalog(active: boolean, trust: CatalogTrust, kaomojiTrust?: CatalogTrust): readonly LauncherInternalResultItem[] {
  if (!active) return []
