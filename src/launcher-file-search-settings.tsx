...
export function LauncherFileSearchSettings({ busy, draftFolders, extensionId, onDraftFoldersChange, save, snapshot }: FileSearchSettingsProps): ReactNode {
  ...
  return <section className="space-y-3" data-testid="tocklauncher-file-search-settings">
    ...
    <div hidden={isHidden('FileSearch')}>
    ...
    <div hidden={isHidden('SimpleFileSearch')}>
