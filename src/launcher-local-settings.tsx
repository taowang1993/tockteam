...
export function LauncherLocalSettings({ busy, save, snapshot }: LocalSettingsProps): ReactNode {
  ...
  return <Accordion type="multiple" defaultValue={['base64']} data-testid="tocklauncher-local-settings">
    <AccordionItem value="base64"><AccordionTrigger>{launcherFixedText('Base64 Conversion')}</AccordionTrigger><AccordionContent forceMount><div className="pl-3">
    ...
    <AccordionItem value="calculator"><AccordionTrigger>{launcherFixedText('Calculator')}</AccordionTrigger><AccordionContent forceMount><div className="pl-3">
