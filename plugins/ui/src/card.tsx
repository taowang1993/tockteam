...
function Card({ className, unstyled = false, ...props }: CardPartProps): React.ReactElement {
...
function CardHeader({ className, unstyled = false, ...props }: CardPartProps): React.ReactElement {
...
function CardTitle({ className, unstyled = false, ...props }: CardPartProps): React.ReactElement {
  return <div data-slot="card-title" className={unstyled ? className : cn('font-medium', className)} {...props} />
}

function CardDescription({ className, unstyled = false, ...props }: CardPartProps): React.ReactElement {
  return <div data-slot="card-description" className={unstyled ? className : cn('text-sm text-muted-foreground', className)} {...props} />
}

function CardContent({ className, unstyled = false, ...props }: CardPartProps): React.ReactElement {
  return <div data-slot="card-content" className={unstyled ? className : cn('px-4', className)} {...props} />
}

function CardFooter({ className, unstyled = false, ...props }: CardPartProps): React.ReactElement {
  return <div data-slot="card-footer" className={unstyled ? className : cn('flex items-center px-4', className)} {...props} />
}

function CardAction({ className, unstyled = false, ...props }: CardPartProps): React.ReactElement {
