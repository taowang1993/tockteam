...
import { maximumReaderViewLimits } from './reader.ts'
...
export function parseReaderViewResult(value: unknown): ReaderViewResult {
  ...
  if (typeof input.content !== 'string'
    || input.content.length > maximumReaderViewLimits.maxReaderOutputChars
    || typeof input.sourceUrl !== 'string'
    || typeof input.title !== 'string'
    || input.title.length > maximumReaderViewLimits.maxReaderTitleChars
    || !Array.isArray(input.warnings)
    || input.warnings.length > maximumReaderViewLimits.maxReaderWarnings
    || input.warnings.some(warning => typeof warning !== 'string' || warning.length > maximumReaderViewLimits.maxReaderWarningChars)) {
