...
function WebViewer(props = {}) {
  ...
  const navigationIntent = (0, import_react5.useRef)(0);
  const pendingNavigation = (0, import_react5.useRef)(null);
  ...
  const loadBlankFrame = (0, import_react5.useCallback)((intent) => {
  ...
  const startNavigation = (0, import_react5.useCallback)((url, tabId, intent) => {
    if (!bridge) return;
    const element = webview.current;
  ...
  const clearFrame = (0, import_react5.useCallback)(() => {
    const intent = ++navigationIntent.current;
