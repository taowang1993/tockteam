...
function WebViewer() {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": "Web Viewer", style: { display: "flex", flex: 1, flexDirection: "column", minHeight: 0 }, children: [
    ...
    /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "form",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { disabled: loading || clipApplying, type: "submit", children: loading ? "Loading\u2026" : "Go" }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
            "button",
            {
              disabled: !active?.url,
    ...
    viewer.bookmarks.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("details", { children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("summary", { children: "Bookmarks" }),
      viewer.bookmarks.map((bookmark) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("span", { children: [
        /* @__PURE__ */ (0, import_jsx_runtime.jsx)("button", { disabled: clipApplying, onClick: () => {
    ...
    error && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { role: "alert", children: error }),
    reader && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
      "article",
      {
        ...
        children: [
              ...
              /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
                "select",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "md", children: "Default" }),
                    /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: "relaxed", children: "Relaxed" })
                  ]
                }
              )
            ] }),
          ...
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h2", { children: reader.title }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("section", { "aria-label": "Clip Web Page", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("label", { children: [
              "Clip Destination",
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
                "input",
            ...
            clipPreview && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { children: [
              /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { children: "Review the exact Markdown and destination before saving." }),
            ...
            clipSavedPath && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("p", { role: "status", children: [
              "Saved clip to ",
              clipSavedPath,
              "."
            ] })
...
function apply(ctx) {
  ...
  void desktop.getInfo().then((info) => {
    ...
    remove = sidebar.registerTab({
      id: "web-clip",
      order: 31,
      render: () => /* @__PURE__ */ (0, import_jsx_runtime.jsx)(WebViewer, {}),
      single: true,
      title: "Web Viewer"
    });
  }).catch(() => void 0);
