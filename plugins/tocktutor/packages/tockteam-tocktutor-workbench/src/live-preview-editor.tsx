...
import { parseFrontmatterProperties, type PropertyType, type PropertyValue } from './properties.ts'
                  ...
                  return (
                    <div className="contents" key={property.key}>
                      ...
                      <dd className="m-0 flex min-h-8 min-w-0 flex-wrap items-center gap-1 py-1 text-[var(--tt-text)]">
                        {tags === null
                          ? checkbox
                            ? <Checkbox aria-label={property.key} checked={property.value === true} className="size-4 cursor-default disabled:opacity-100 data-[state=checked]:!border-[var(--dsw-specific-markdown-accent)] data-[state=checked]:!bg-[var(--dsw-specific-markdown-accent)] data-[state=checked]:!text-[#000]" disabled />
