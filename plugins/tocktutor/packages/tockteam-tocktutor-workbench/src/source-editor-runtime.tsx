...
export function SourceEditorRuntime(props: SourceEditorProps): ReactNode {
  ...
  return <div aria-label={props.ariaLabel ?? 'Markdown Source Editor'} className={`tocktutor-source-editor flex min-h-0 min-w-0 flex-1 overflow-hidden focus-within:outline-2 focus-within:outline-offset-[-2px] focus-within:outline-[var(--tt-accent)] [&_.cm-editor]:h-full [&_.cm-editor]:bg-[var(--tt-panel)] [&_.cm-editor]:text-[var(--tt-text)] [&_.cm-editor]:[font:16px/1.5_ui-monospace,SFMono-Regular,Consolas,monospace] [&_.cm-scroller]:overflow-auto [&_.cm-scroller]:leading-6 [&_.cm-gutters]:border-0 [&_.cm-gutters]:bg-transparent [&_.cm-content]:pt-[30px] [&_.cm-content]:pr-7 [&_.cm-content]:pb-[72px] [&_.cm-lineNumbers]:text-[var(--tt-muted)] [&_.cm-tock-code-line]:text-[var(--tt-muted)] [&_.cm-tock-comment]:text-[var(--tt-muted)] ${props.className ?? ''}`} id={props.id}><div className="min-h-0 min-w-0 flex-1" ref={parentRef} /></div>
}
