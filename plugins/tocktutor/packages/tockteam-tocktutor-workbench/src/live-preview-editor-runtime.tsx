...
function LivePreviewEditorInner(props: LivePreviewEditorProps): ReactNode {
  ...
  const shellClass = useMemo(() => `tocktutor-live-preview-editor relative min-h-0 min-w-0 flex-1 overflow-auto text-base leading-6 [&_blockquote]:mx-0 [&_blockquote]:my-4 [&_blockquote]:border-l-2 [&_blockquote]:border-[var(--dsw-alias-brand-primary)] [&_blockquote]:pl-3 [&_blockquote_p]:m-0 [&_a]:text-[var(--dsw-alias-brand-primary)] [&_a]:underline [&_a]:decoration-1 [&_a]:underline-offset-2 [&_.tocktutor-live-internal-link]:text-[var(--dsw-alias-brand-primary)] [&_.tocktutor-live-internal-link]:underline [&_.tocktutor-live-internal-link]:decoration-1 [&_.tocktutor-live-internal-link]:underline-offset-2 [&_h1]:text-[30px] [&_h1]:leading-tight [&_h2]:text-2xl [&_h2]:leading-8 [&_h3]:text-xl [&_h3]:leading-7 [&_ul:has(li[data-item-type=task])]:m-0 [&_ul:has(li[data-item-type=task])]:list-none [&_ul:has(li[data-item-type=task])]:pl-1 [&_li[data-item-type=task]]:min-h-6 [&_li[data-item-type=task]]:leading-6 [&_li[data-item-type=task]>p]:my-0 [&_li[data-item-type=task]>p]:inline [&_li[data-checked=true]>p]:text-[var(--tt-muted)] [&_li[data-checked=true]>p]:line-through [&_table]:my-4 [&_table]:border-collapse [&_table_p]:m-0 [&_th]:border [&_th]:border-[var(--dsw-alias-border-l2,var(--tt-border))] [&_th]:px-2 [&_th]:py-1 [&_th]:text-left [&_th]:font-semibold [&_td]:border [&_td]:border-[var(--dsw-alias-border-l2,var(--tt-border))] [&_td]:px-2 [&_td]:py-1 [&_.selectedCell]:bg-[var(--tt-selected)] ${props.className ?? ''}`, [props.className])
