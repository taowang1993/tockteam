...
export function TockTutorRoute(props) {
    ...
    useEffect(() => {
        if (snapshot.documentKind !== 'markdown' || snapshot.path === null || snapshot.settings === undefined)
            return;
