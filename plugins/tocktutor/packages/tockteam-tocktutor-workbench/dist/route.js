...
function ReadingBlockView(props) {
    ...
    switch (block.kind) {
        ...
        case 'task': return (_jsxs("label", { className: "tocktutor-task my-2 flex items-start gap-2", children: [_jsx(Input, { unstyled: true, "aria-label": `Mark ${block.text} as ${block.checked ? 'incomplete' : 'complete'}`, checked: block.checked, onChange: () => { props.onToggleTask(block.index); }, type: "checkbox" }), _jsx("span", { children: block.text })] }));
    }
}
