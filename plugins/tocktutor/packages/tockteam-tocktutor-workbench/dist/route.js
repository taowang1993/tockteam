...
export function TockTutorRouteView(props) {
    ...
    const titlebar = (_jsxs("header", { "aria-label": "TockTutor Title Bar", className: "tocktutor-titlebar", children: [_jsxs("div", { className: "tocktutor-titlebar-sidebar", children: [_jsx("span", { className: "tocktutor-titlebar-document", children: _jsx(WorkbenchGlyph, { kind: "document" }) }), _jsx("span", { children: _jsx(WorkbenchGlyph, { kind: "document" }) }), _jsx("button", { "aria-label": "Search Notes", onClick: () => { props.onSearchChange?.(snapshot.searchQuery); }, type: "button", children: _jsx(WorkbenchGlyph, { kind: "search" }) }), _jsx("span", { children: _jsx(WorkbenchGlyph, { kind: "bookmark" }) }), _jsx("span", { children: _jsx(WorkbenchGlyph, { kind: "panel" }) })] }), _jsxs("div", { className: "tocktutor-titlebar-main", children: [_jsxs("span", { className: "tocktutor-history", children: [_jsx(WorkbenchGlyph, { kind: "back" }), _jsx(WorkbenchGlyph, { kind: "forward" })] }), _jsx("div", { "aria-label": "Note Tabs", className: "tocktutor-tabs", role: "tablist", children: focusedPane?.tabs.map((tab, index) => (_jsxs("button", { "aria-selected": tab.path === focusedPane.activePath, onClick: () => { props.onActivateTab(focusedPane.id, tab.path); }, onKeyDown: event => {
