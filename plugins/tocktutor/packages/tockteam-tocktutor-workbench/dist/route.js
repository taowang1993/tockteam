...
import { Bookmark, ChevronLeft, ChevronRight, Ellipsis, FileText, Folder, MessageSquare, Music, PanelLeft, PanelRight, PanelTop, Pencil, Plus, Search, SlidersHorizontal, Upload, X, } from 'lucide-react';
    ...
    return (_jsx(Dialog, { open: true, onOpenChange: open => { if (!open)
            props.onClose(); }, children: _jsxs(DialogContent, { unstyled: true, className: "fixed top-1/2 left-1/2 z-[2147483647] grid h-[600px] max-h-[calc(100vh-48px)] w-[calc(100%-32px)] max-w-[900px] -translate-1/2 grid-rows-[60px_minmax(0,1fr)_44px] overflow-hidden rounded-[14px] border border-border bg-[var(--tt-panel)] text-[var(--tt-text)] shadow-xl outline-none [--tt-accent:var(--dsw-alias-brand-primary,#533afd)] [--tt-border:var(--dsw-alias-border-l1,var(--dsw-alias-border-subtle,#e1e3e7))] [--tt-muted:var(--dsw-alias-label-secondary,#71717a)] [--tt-panel:var(--dsw-alias-bg-layer-1,#fff)] [--tt-selected:color-mix(in_srgb,var(--tt-accent)_14%,var(--tt-panel))] [--tt-text:var(--dsw-alias-label-primary,#27272a)]", overlayClassName: "z-[2147483646] !bg-transparent", showCloseButton: false, children: [_jsx(DialogTitle, { className: "sr-only", children: "Search Notes" }), _jsxs("div", { ref: searchInputContainer, className: "flex min-w-0 items-center gap-3 border-b border-[var(--tt-border)] px-4 text-[var(--tt-muted)] [&>svg]:size-[18px]", children: [_jsx(Search, { "aria-hidden": "true" }), _jsx(Input, { unstyled: true, "aria-label": "Search Notes Query", autoFocus: true, className: "h-full min-w-0 flex-1 border-0 bg-transparent p-0 text-[15px] font-medium text-[var(--tt-text)] outline-none placeholder:text-[var(--tt-muted)]", maxLength: 1_000, onChange: event => { props.onSearchChange?.(event.target.value); }, onKeyDown: event => {
                                ...
                                props.onRunSearch?.();
                                    ...
                                    }, role: "dialog", sideOffset: 8, children: [_jsxs(PopoverHeader, { className: "gap-0.5 px-1.5 pt-0.5", children: [_jsx(PopoverTitle, { className: "text-xs font-semibold", children: "Search syntax" }), _jsx(PopoverDescription, { className: "m-0 text-xs text-[var(--dsw-alias-label-secondary,#71717a)]", children: "Insert an operator at the cursor." })] }), _jsx("ul", { className: "m-0 grid list-none gap-1 p-0", children: SEARCH_OPTIONS.map(option => (_jsx("li", { children: _jsxs(Button, { unstyled: true, className: "grid w-full cursor-pointer grid-cols-[76px_1fr] items-start gap-2 rounded-lg border-0 bg-transparent px-2.5 py-2 text-left hover:bg-[var(--dsw-alias-interactive-bg-hover,rgba(0,0,0,0.05))] focus-visible:bg-[var(--dsw-alias-interactive-bg-hover,rgba(0,0,0,0.05))] focus-visible:outline-none", onClick: () => { insertSearchOption(option.value); }, type: "button", children: [_jsx("code", { className: "font-mono text-xs font-semibold leading-4 text-[var(--dsw-alias-brand-primary,#533afd)]", children: option.label }), _jsx("span", { className: "text-xs leading-4 text-[var(--dsw-alias-label-secondary,#71717a)]", children: option.description })] }) }, option.label))) })] })] }))] }), _jsxs("section", { className: "grid min-h-0 grid-rows-[52px_minmax(0,1fr)] px-4 pb-4", "aria-label": "Note Search Results", children: [_jsxs("header", { className: "flex items-center justify-between gap-3 border-b border-[var(--tt-border)] text-xs font-medium text-[var(--tt-muted)]", children: [_jsxs("div", { className: "flex gap-1", children: [_jsx(Button, { unstyled: true, "aria-pressed": (snapshot.searchMode ?? 'query') === 'query', className: "rounded border border-[var(--tt-border)] bg-transparent px-2 py-1 aria-pressed:border-[var(--tt-accent)]", onClick: () => { props.onSearchMode?.('query'); }, type: "button", children: "Keyword" }), _jsx(Button, { unstyled: true, "aria-pressed": snapshot.searchMode === 'related', className: "rounded border border-[var(--tt-border)] bg-transparent px-2 py-1 aria-pressed:border-[var(--tt-accent)]", onClick: () => { props.onSearchMode?.('related'); }, type: "button", children: "Related" }), _jsx(Button, { unstyled: true, className: "rounded border border-[var(--tt-border)] bg-transparent px-2 py-1", disabled: snapshot.searchLoading === true || snapshot.searchQuery.trim() === '', onClick: props.onRunSearch, type: "button", children: snapshot.searchLoading === true ? 'Searching…' : 'Search' })] }), _jsx(Alert, { unstyled: true, "aria-live": "polite", className: "text-xs text-[var(--tt-muted)]", role: "status", children: matches.length > 0 ? `${String(matches.length)} vault results.` : `${String(pathResults.length)} matching note paths.` })] }), _jsx("div", { className: "min-h-0 overflow-auto py-2", children: matches.length > 0 ? (_jsx("ul", { className: "m-0 grid list-none gap-1 p-0", "aria-label": "Vault Search Results", children: matches.map(match => (_jsx("li", { children: _jsxs(Button, { unstyled: true, className: "w-full rounded-md border-0 bg-transparent px-2.5 py-2 text-left hover:bg-[var(--tt-selected)] focus-visible:bg-[var(--tt-selected)]", onClick: () => { props.onSelect(match.path); props.onClose(); }, type: "button", children: [_jsxs("strong", { className: "block truncate text-sm", children: [match.path, match.line === null ? '' : `:${String(match.line)}`] }), _jsx("span", { className: "block truncate text-xs text-[var(--tt-muted)]", children: match.preview })] }) }, `${match.kind}:${match.path}:${String(match.line ?? 0)}:${match.preview}`))) })) : pathResults.length > 0 ? (_jsx("ul", { className: "m-0 grid list-none gap-1 p-0", "aria-label": "Matching Note Paths", children: pathResults.map(path => (_jsx("li", { children: _jsx(Button, { unstyled: true, className: "w-full rounded-md border-0 bg-transparent px-2.5 py-2 text-left text-sm hover:bg-[var(--tt-selected)] focus-visible:bg-[var(--tt-selected)]", onClick: () => { props.onSelect(path); props.onClose(); }, type: "button", children: path }) }, path))) })) : _jsx(Alert, { unstyled: true, className: "px-2.5 py-2 text-sm text-[var(--tt-muted)]", role: "status", children: snapshot.searchQuery.trim() === '' ? 'Type to search notes.' : 'No matching notes.' }) })] }), _jsxs("footer", { className: "flex items-center gap-5 border-t border-[var(--tt-border)] px-4 text-xs text-[var(--tt-muted)]", children: [_jsx(Button, { unstyled: true, className: "rounded border border-[var(--tt-border)] bg-transparent px-2 py-1 text-[var(--tt-text)]", onClick: props.onCommands, type: "button", children: "Commands" }), _jsxs("span", { className: "ml-auto flex items-center gap-1.5", children: [_jsx("kbd", { className: "rounded border border-[var(--tt-border)] bg-[var(--tt-panel)] px-1.5 py-0.5 font-[inherit] text-[var(--tt-text)] shadow-sm", children: "Enter" }), " Search"] }), _jsxs("span", { className: "flex items-center gap-1.5", children: [_jsx("kbd", { className: "rounded border border-[var(--tt-border)] bg-[var(--tt-panel)] px-1.5 py-0.5 font-[inherit] text-[var(--tt-text)] shadow-sm", children: "Esc" }), " Dismiss"] })] })] }) }));
}
function WorkbenchCommandPalette(props) {
    ...
    return (_jsx(Dialog, { open: true, onOpenChange: open => { if (!open)
            props.onClose(); }, children: _jsxs(DialogContent, { unstyled: true, className: "fixed top-1/2 left-1/2 z-[2147483647] grid h-[600px] max-h-[calc(100vh-48px)] w-[calc(100%-32px)] max-w-[900px] -translate-1/2 grid-rows-[60px_minmax(0,1fr)_44px] overflow-hidden rounded-[14px] border border-border bg-[var(--tt-panel)] text-[var(--tt-text)] shadow-xl outline-none [--tt-accent:var(--dsw-alias-brand-primary,#533afd)] [--tt-border:var(--dsw-alias-border-l1,var(--dsw-alias-border-subtle,#e1e3e7))] [--tt-muted:var(--dsw-alias-label-secondary,#71717a)] [--tt-panel:var(--dsw-alias-bg-layer-1,#fff)] [--tt-selected:color-mix(in_srgb,var(--tt-accent)_14%,var(--tt-panel))] [--tt-text:var(--dsw-alias-label-primary,#27272a)]", overlayClassName: "z-[2147483646] !bg-transparent", showCloseButton: false, children: [_jsx(DialogTitle, { className: "sr-only", children: "Command Palette" }), _jsxs(Label, { unstyled: true, className: "flex min-w-0 items-center gap-3 border-b border-[var(--tt-border)] px-4 text-[var(--tt-muted)] [&>svg]:size-[18px]", children: [_jsx(Search, { "aria-hidden": "true" }), _jsx(Input, { unstyled: true, "aria-label": "Search Commands", autoFocus: true, className: "h-full min-w-0 flex-1 border-0 bg-transparent p-0 text-[15px] font-medium text-[var(--tt-text)] outline-none placeholder:text-[var(--tt-muted)]", maxLength: 200, onChange: event => { setQuery(event.target.value); }, placeholder: "Search", value: query })] }), _jsxs("div", { className: "grid min-h-0 grid-cols-[minmax(0,1fr)_minmax(240px,32%)] gap-6 px-4 pb-4 max-sm:grid-cols-1", children: [_jsxs("section", { className: "grid min-h-0 grid-rows-[52px_minmax(0,1fr)]", "aria-label": "Command Results", children: [_jsxs("header", { className: "flex items-center justify-between gap-3 text-xs font-medium text-[var(--tt-muted)]", children: [_jsx("span", { children: "Search Results" }), _jsx("span", { children: "Best Matches" })] }), _jsxs("div", { className: "grid auto-rows-max gap-1 overflow-auto", role: "listbox", "aria-label": "Command Search Results", children: [commands.map(command => (_jsx(Button, { unstyled: true, className: "min-h-9 rounded-md border-0 bg-transparent px-2.5 py-2 text-left text-sm text-[var(--tt-text)] outline-none hover:bg-[var(--tt-selected)] focus-visible:bg-[var(--tt-selected)] disabled:opacity-40", disabled: command.disabled === true || command.run === undefined, onClick: () => {
                                                command.run?.();
                                                if (command.close !== false)
                                                    props.onClose();
                                            }, role: "option", type: "button", children: command.label }, command.label))), commands.length === 0 && _jsx(Alert, { unstyled: true, className: "px-2.5 py-2 text-sm text-[var(--tt-muted)]", role: "status", children: "No matching commands." })] })] }), _jsx("section", { className: "mt-[52px] min-h-0 rounded-xl border border-[var(--tt-border)] p-5 max-sm:hidden", "aria-label": "Command Preview", children: _jsxs("div", { className: "flex h-full flex-col justify-center gap-2", children: [_jsx("strong", { className: "text-sm font-semibold", children: "Command Preview" }), _jsx("p", { className: "m-0 text-sm leading-5 text-[var(--tt-muted)]", children: "Choose a command to run it in TockTutor." })] }) })] }), _jsxs("footer", { className: "flex items-center gap-5 border-t border-[var(--tt-border)] px-4 text-xs text-[var(--tt-muted)]", children: [_jsxs("span", { className: "flex items-center gap-1.5", children: [_jsx("kbd", { className: "rounded border border-[var(--tt-border)] bg-[var(--tt-panel)] px-1.5 py-0.5 font-[inherit] text-[var(--tt-text)] shadow-sm", children: "Enter" }), " Run"] }), _jsxs("span", { className: "flex items-center gap-1.5", children: [_jsx("kbd", { className: "rounded border border-[var(--tt-border)] bg-[var(--tt-panel)] px-1.5 py-0.5 font-[inherit] text-[var(--tt-text)] shadow-sm", children: "Esc" }), " Dismiss"] })] })] }) }));
}
...
export function TockTutorRouteView(props) {
    ...
    const launcher = globalThis.dshDesktop?.launcher;
