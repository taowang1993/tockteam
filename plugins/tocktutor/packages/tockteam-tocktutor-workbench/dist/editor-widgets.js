 ...
 */
export function projectEditorWidgets(source, selection = { from: 0, to: 0 }) {
...
export function projectEditorStaticWidgets(source, selection = { from: 0, to: 0 }) {
        ...
        if (opening !== null) {
            ...
            if (closed) {
                ...
                widgets.push(Object.freeze({
                    ...
                    from: start,
                    kind: opening[2].toLocaleLowerCase(),
                    selected,
                    source: raw,
                    to: end,
                    visible: !selected,
...
//# sourceMappingURL=editor-widgets.js.map