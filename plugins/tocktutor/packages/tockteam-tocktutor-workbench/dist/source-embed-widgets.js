...
export function buildSourceEmbedWidgetExtension(getEmbeds) {
    ...
    const reveal = (event, view) => {
        ...
        if (!Number.isSafeInteger(from) || !Number.isSafeInteger(to) || from < 0 || to <= from || to > view.state.doc.length)
            return false;
...
//# sourceMappingURL=source-embed-widgets.js.map