...
export function ImportExportReviewPanel(props) {
    ...
    if (props.vault === null)
        return null;
    return (_jsx(ImportExportReviewPanelView, { onApprove: () => { void controller.approveAndCommit(); }, onCancel: () => { void controller.cancel(); }, onFormat: format => { controller.setFormat(format); }, onStart: format => { void controller.startImport(format); }, onStartBackup: () => { void controller.startBackup(); }, snapshot: snapshot }));
}
