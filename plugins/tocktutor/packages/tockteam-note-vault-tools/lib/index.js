...
async function executeNotesSearch(ctx, rawArgs, signal) {
    ...
    try {
        const runtimeArgs = {
            ...
            limit: args.limit,
            [MARKDOWN_ONLY_SEARCH]: true,
        };
        raw = await ctx.noteVault.search(runtimeArgs, expected, signal);
    }
    catch (error) {
...
export function apply(context) {
    ...
    ctx.tools.register({
        ...
        isConcurrencySafe: () => true,
        async execute(args, exec) {
            return withoutGeneration(await ctx.noteVault.list(args, activeVault(ctx), exec.signal));
        },
    });
    ctx.tools.register({
        name: 'vault_links',
        ...
        isConcurrencySafe: () => true,
        async execute(args, exec) {
            return withoutGeneration(await ctx.noteVault.links(args, activeVault(ctx), exec.signal));
        },
    });
    ctx.tools.register({
        name: 'vault_outline',
        ...
        isConcurrencySafe: () => true,
        async execute(args, exec) {
            return withoutGeneration(await ctx.noteVault.outline(args, activeVault(ctx), exec.signal));
        },
    });
    ctx.tools.register({
        name: 'vault_graph',
        ...
        isConcurrencySafe: () => true,
        async execute(args, exec) {
            return withoutGeneration(await ctx.noteVault.graph(args, activeVault(ctx), exec.signal));
        },
    });
    ctx.tools.register({
        name: 'vault_canvas',
        ...
        isConcurrencySafe: () => true,
        async execute(args, exec) {
            return withoutGeneration(await ctx.noteVault.canvas(args, activeVault(ctx), exec.signal));
        },
    });
    ctx.tools.register({
        name: 'vault_facets',
        ...
        isConcurrencySafe: () => true,
        async execute(args, exec) {
            return withoutGeneration(await ctx.noteVault.facets(args, activeVault(ctx), exec.signal));
        },
    });
}
