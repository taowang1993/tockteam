                    ...
                    setShowJumpToLatest(!atBottom);
                            ...
                            : (_jsxs("article", { "aria-label": `${entry.label} transcript entry`, className: entry.label === 'You' || entry.label === 'Steering'
                                    ...
                                    setMenuOpen(false);
                                            ...
                                            }), auditPage !== null && (auditOffset > 0 || auditPage.nextOffset !== null) && (_jsxs("nav", { "aria-label": "Audit Pages", className: "flex flex-wrap gap-1.5", children: [_jsx("button", { "aria-label": "Previous Audit Page", className: "cursor-pointer rounded-[7px] border border-[var(--tta-border)] bg-[var(--tta-panel)] px-[9px] py-1.5 font-semibold text-inherit disabled:cursor-default disabled:opacity-50", disabled: auditOffset === 0, onClick: () => { void loadAudit(Math.max(0, auditOffset - 20)); }, type: "button", children: "Previous" }), _jsx("button", { "aria-label": "Next Audit Page", className: "cursor-pointer rounded-[7px] border border-[var(--tta-border)] bg-[var(--tta-panel)] px-[9px] py-1.5 font-semibold text-inherit disabled:cursor-default disabled:opacity-50", disabled: auditPage.nextOffset === null, onClick: () => { if (auditPage.nextOffset !== null)
                                                            void loadAudit(auditPage.nextOffset); }, type: "button", children: "Next" })] }))] })] })] }), _jsxs("form", { className: "tocktutor-assistant-composer flex min-h-24 flex-col gap-2 rounded-2xl border border-[var(--tta-border)] bg-[var(--tta-panel)] p-2.5 focus-within:border-[var(--tta-accent)]", onSubmit: send, children: [_jsx("textarea", { "aria-label": "Assistant Message", className: "min-h-12 w-full resize-none border-0 bg-transparent p-0 text-[13px] leading-[18px] text-inherit outline-0 focus-visible:shadow-none focus-visible:outline-none", id: "tocktutor-assistant-message", maxLength: 8_000, onChange: event => { setMessage(event.target.value); }, onKeyDown: submitOnEnter, placeholder: "What are your thoughts?", rows: 3, value: message }), _jsxs("div", { className: "flex items-center justify-between", children: [_jsx("button", { "aria-controls": "tocktutor-assistant-add-menu", "aria-expanded": menuOpen, "aria-label": "Add Context", className: "tocktutor-assistant-icon-button flex size-7 cursor-pointer items-center justify-center rounded-[7px] border-0 bg-transparent p-0 text-inherit [&_svg]:size-3.5", onClick: () => { setMenuOpen(open => !open); }, type: "button", children: _jsx(Plus, { "aria-hidden": "true" }) }), _jsx("button", { "aria-label": "Send", className: "tocktutor-assistant-send flex size-7 cursor-pointer items-center justify-center rounded-full border-0 bg-[var(--tta-accent)] p-0 text-white disabled:cursor-default disabled:opacity-50 [&_svg]:size-3.5 [&_svg]:stroke-white [&_svg]:text-white", disabled: message.trim() === '', type: "submit", children: _jsx(ArrowUp, { "aria-hidden": "true" }) })] })] })] }), _jsx("p", { "aria-live": "polite", className: "tocktutor-assistant-status absolute right-3 bottom-[120px] left-3 z-2 rounded-[7px] bg-[color-mix(in_srgb,var(--tta-accent)_9%,var(--tta-panel))] px-2.5 py-2 text-xs text-[var(--tta-muted)] empty:hidden", ref: statusRef, role: "status", tabIndex: -1, children: status === null ? '' : boundedText(status, 500) })] }));
}
