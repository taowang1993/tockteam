...
export function TockTutorAssistantPanel(props) {
    ...
    return (_jsx(TooltipProvider, { children: _jsxs("aside", { "aria-label": "TockTutor Assistant", className: cn(ASSISTANT_SURFACE, 'tocktutor-assistant-panel relative flex h-full min-h-0 w-full min-w-0 flex-col overflow-hidden bg-[var(--tta-panel)]'), children: [_jsx("div", { className: "tocktutor-assistant-scroll flex min-h-0 flex-[1_1_auto] flex-col overflow-auto p-3.5", onScroll: event => {
