...
test('the contract preserves the current TockTeam identity and configured package formats', async () => {
  ...
  assert.deepEqual(foundation, {
    ...
    runtimeDependencyClosure: [
      '@babel/runtime@7.29.7', '@nodable/entities@2.2.0', 'anynum@1.0.1', 'argparse@2.0.1', 'builder-util-runtime@9.5.1',
      'color-convert@2.0.1', 'color-name@1.1.4', 'color-string@1.9.1', 'color@4.2.3', 'complex.js@2.4.3', 'debug@4.4.3',
      'decimal.js@10.6.0', 'electron-updater@6.8.3', 'escape-latex@1.2.0', 'fast-xml-builder@1.3.1', 'fast-xml-parser@5.7.0',
      ...
      'mathjs@15.2.0', 'ms@2.1.3', 'path-expression-matcher@1.6.2', 'sax@1.6.1', 'seedrandom@3.0.5', 'semver@7.7.4',
      'simple-swizzle@0.2.4', 'strnum@2.4.2', 'tiny-emitter@2.1.0', 'tiny-typed-emitter@2.1.0', 'typed-function@4.2.2',
      'universalify@2.0.1', 'uuid@14.0.0', 'xml-naming@0.3.0',
    ],
    launcherAssets: [],
    launcherNotices: [],
