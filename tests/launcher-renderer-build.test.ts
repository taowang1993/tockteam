...
const tailwind = readFileSync(new URL('../plugins/skins/src/client/tailwind.css', import.meta.url), 'utf8')
...
test('launcher renderer uses the compact Tockbot composition', () => {
  ...
  assert.match(launcher, /border-\[color-mix\(in_srgb,var\(--dsw-alias-label-primary,CanvasText\)_12%/u)
