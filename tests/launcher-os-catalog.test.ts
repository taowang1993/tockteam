...
test('OS catalogs and fixed effects match the pinned Ueli v9.29.0 tuples', () => {
  ...
  // TockTeam applies product naming and Title Case to the pinned command labels.
  assert.equal(digest(UELI_COMMAND_CATALOG), '97eb452a612917ae1b1e90a5e031aee1bbc49b5b709f54bc78ea108c6093c8d9')
