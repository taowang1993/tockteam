<div align="center">
  <img src="./assets/tockteam-logo.svg?v=2" width="136" alt="TockTeam logo">
  <h1>TockTeam</h1>
...
- [Architecture and plugin boundaries](./.agents/references/architecture.md)
- [Installation, operations, and troubleshooting](./.agents/references/usage.md)
