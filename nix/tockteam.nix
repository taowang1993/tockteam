...
let
  ...
  tockTeamBundle = pkgs.stdenv.mkDerivation rec {
    ...
    pnpmDeps = pkgs.fetchPnpmDeps {
      ...
      fetcherVersion = 4;
      hash = "sha256-pTPfxwvVIG+VbI/WPkb7I+IRxxlQfcU5HGARC1tN9wc=";
    };
    ...
    installPhase = ''
      ...
      cp package.json client.d.ts host.d.ts LICENSE THIRD_PARTY_NOTICES.md $out/lib/tockteam/
...
pkgs.stdenv.mkDerivation {
  ...
  installPhase = ''
    ...
    cp ${tockTeamBundle}/lib/tockteam/LICENSE ${tockTeamBundle}/lib/tockteam/THIRD_PARTY_NOTICES.md $out/
